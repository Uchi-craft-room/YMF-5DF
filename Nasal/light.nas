...
setlistener("/engines/engine[0]/n2",func{
             interpolate("/sim/rendering/als-secondary-lights/use-taxi-light-ext",getprop("/controls/switches/landing-light"),0)});
setlistener("/engines/engine[0]/n2",func{
             interpolate("/sim/rendering/als-secondary-lights/use-landing-light-ext",getprop("/controls/switches/landing-light"),0)});
